...
$url        = 'http://www.aplusfreeware.com/categories/LFWV/files/spcmn140.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'spacemonger.portable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
